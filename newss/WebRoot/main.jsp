    ...
    <div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i>${sessionScope.user.userName} </h2>
						<div class="box-icon">
					...
					<div class="box-content">
					 ...
					 <c:forEach items="${requestScope.datails}" var="datail">
						  <tbody>
							<tr>
								<td>${datail.id}</td>
								<td class="center">${datail.title}</td>
								...
								<td class="center">
									...
									<a class="btn btn-info" href="UpdateByIdServlet?id=${datail.id}">
										<i class="icon-edit icon-white"></i>  
										修改                                            
									</a>
									<a class="btn btn-dange r" href="#" onclick="del('DelServlet?id=${datail.id}')">
	    ...
	    <li><a href="ListServlet?pageIndex=${page.pageIndex+1}">下一页</a></li>
 	    <li><a href="ListServlet?pageIndex=${page.pageCount}">尾页</a></li>
			...
			<div class="modal-footer">
				...
				<a href="#"  onclick ="submit()" class="btn btn-primary">删除</a>
			</div>
		</div>
